...
INSERT INTO employee (name, department_code) VALUES ('고동현', 'FI');
...
-- RIGHT OUTER JOIN (RIGHT JOIN) : 두 번째 테이블에 있는 모든 레코드와 첫 번째 테이블에 있는 조건이 일치하는 레코드를 반환,
-- 두 번째 테이블의 레코드에서 일치하는 값이 없다면 NULL로 반환 
SELECT 
E.employee_number AS employee_number,
E.name AS employee_name,
D.code AS department_code,
