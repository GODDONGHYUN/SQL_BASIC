...
-- 6. 게시물 작성
INSERT INTO qna (title, contents, writer_id) VALUES('질문있습니다', '데이터는 언제 데이터 인가요?', 'userID');

-- 7. 게시물 목록 보기
-- 접수번호, 완료 상태ㅡ 제목, 작성자 아이디, 작성일, 조회수
...
-- 11 . 관리자로 답변 작성
UPDATE qna SET reply = '2023년 데이터 입니다', replyer_id = 'userID'
WHERE reception_number = 1;
