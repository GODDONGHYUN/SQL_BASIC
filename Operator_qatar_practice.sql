...
INSERT INTO player VALUES ('양현준', 0, null, null, null, '대한민국');
...
INSERT INTO player VALUES ('아스카 키라라', 0, null, null, null, '일본');
INSERT INTO player VALUES ('미토마 가오루', 0, null, null, null, '일본');
INSERT INTO player VALUES ('엔도 와타루', 0, null, null, null, '일본');

-- 플레이어 이름이 조규성이면 나이를 27, 포지션을 FW, 프로팀을 FC밀트 윌란, 등번호를 10으로 변경
UPDATE player SET age = 27, position = 'FW', pro_team = 'FC 미트 윌란', uniform_number= 10 WHERE name="조규성";
...
-- 플레이어 이름이 쿠보 다케후사이면서 국적이 일본이면 나이를 24, 포지션을 MF/FW, 프로팀을 레알 소시에다드, 등번호를 14로 변경
UPDATE player SET age = 24, position = 'MF/FW', pro_team = '레알 소시에다드', uniform_number= 14 WHERE name="쿠보 다케후사" AND country= "일본"; 
