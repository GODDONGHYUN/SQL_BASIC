...
-- 제한된 보기를 제공할 때, 특정 쿼리문을 미리 작성해두는 용도
...
D.tel_number AS department_tet_number
...
INSERT INTO employee_view VALUES(10, '김길동', 'MM', '물류부', '01011111234'); 
...
# 인덱스 설정한 순서에 따라서 조회를 하기 떄문에 만약 INDEX 순서에 다르게 실행한다면 조회 속도가 느림
SELECT * FROM department WHERE tel_number = '010-1111-1111' AND name = '인사부';

# 인덱스 삭제
DROP INDEX department_index_1
ON department;